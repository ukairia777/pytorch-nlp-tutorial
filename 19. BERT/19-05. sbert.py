...
Original file is located at
    https://colab.research.google.com/drive/1DASCa8SGcYqHsvwNWh6Pzg1gQ6yUBOmS
"""

# 문장 또는 문서를 임베딩 할 수 있는 파이썬 라이브러리
...
model.encode('하루가 또 가네요.')

len(model.encode('하루가 또 가네요.'))
...
# 어떤 두 벡터의 유사도를 구하고 싶을 때는 주로 내적 또는 코사인 유사도를 사용한다.
def cos_sim(A, B):
